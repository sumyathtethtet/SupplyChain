        ...
        <Fade in={open}>
          <div className={classes.paper}>
            {prod.length === 0 ? (
              ...
              <>
                <h1 className={classes.pageHeading}>Product Information</h1>
                <div>
                  ...
                  <div className={classes.dRow}>
                    <div className={classes.dCol1}>Owner Address: </div>{" "}
                    <div className={classes.dCol2}>{prod[0][2]}</div>
                  </div>

                  <div className={classes.dRow}>
                    <div className={classes.dCol1}>Manufacturer Address:</div>{" "}
