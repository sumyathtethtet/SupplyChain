...
export default function PersistentDrawerLeft({ titlePage,navItems, children }) {
  ...
  return (
    <div className={classes.root}>
      ...
      >
        <Toolbar>
          ...
          >
            ...
            />
            &nbsp;Decentralized Supply Chain App
          </Typography>
        </Toolbar>
      </AppBar>
      <Drawer
      ...
      >
        ...
        <ListItemText><b>{titlePage}</b></ListItemText>
